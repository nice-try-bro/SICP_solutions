...
;;---Ex. 1.20----------------------------------------------------------------------------------------------------
;;
;; Normal order evaluation - 18 remainder operations
(gcd 206 40)
(if (= 40 0))
(if #f)
...
(if (= (remainder (remainder 206 40) (remainder 40 (remainder 206 40))) 0)) ;; 5
(if (= (remainder 6 (remainder 40 6)) 0)) ;; 6
(if (= (remainder 6 4) 0)) ;; 7
(if (= 2 0))
(if #f)
(gcd (remainder (remainder 206 40) (remainder 40 (remainder 206 40))) (remainder (remainder 40 (remainder 206 40)) (remainder (remainder 206 40) (remainder 40 (remainder 206 40)))))
(if (= (remainder (remainder 40 (remainder 206 40)) (remainder (remainder 206 40) (remainder 40 (remainder 206 40)))) 0)) ;; 10
(if (= (remainder (remainder 40 6) (remainder 6 (remainder 40 6))) 0)) ;; 12
(if (= (remainder 4 (remainder 6 4)) 0)) ;; 13
(if (= (remainder 4 2) 0)) ;; 14
(if (= 0 0))
(if #t)
(remainder (remainder 206 40) (remainder 40 (remainder 206 40))) ;; 16
